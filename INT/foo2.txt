...
Instant – a point on the time-line (timestamp)
Period and Duration – time between dates or times
DateTimeFormatter – formatting and parsing

LocalDate today = LocalDate.now(); // Current date
LocalDate specificDate = LocalDate.of(2024, 6, 21); // Year, Month, Day
LocalDate parsed = LocalDate.parse("2025-01-01");

LocalTime now = LocalTime.now();
LocalTime fixed = LocalTime.of(14, 30, 15); // 2:30:15 PM

LocalDateTime now = LocalDateTime.now();
LocalDateTime meeting = LocalDateTime.of(2025, 6, 21, 10, 0);
...
LocalDate parsed = LocalDate.parse("21 Jun 2025", formatter);


================================================== java.io, java.nio.file 

Class	Use
File	Basic file metadata and operations
FileReader / FileWriter	Reading/writing characters
BufferedReader / BufferedWriter	Efficient I/O with buffering
FileInputStream / FileOutputStream	Byte-level read/write
Paths / Path	Modern way to handle file paths
Files	Static methods for reading/writing files
...
- intellij plugins: smithy, gradle -- how to install and use a pluggin
